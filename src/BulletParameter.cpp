...
{
	mParamsPhysics = mndl::params::PInterfaceGl( "Physics", Vec2i( 250, 550 ), Vec2i( 300, 50 ) );
	mParamsDebugDraw.addText( "World" );
	mParamsPhysics.addPersistentSizeAndPosition();

	mParamsPhysics.addPersistentParam( "Gravity", &mGravity, Vec3f( 0.0f, -9.81f, 0.0f ) );
	...
	mParamsDebugDraw = mndl::params::PInterfaceGl( "DebugDraw", Vec2i( 250, 550 ), Vec2i( 580, 50 ) );
